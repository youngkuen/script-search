...
직접·간결 답변 규칙(4번)은 RAGAS Answer Relevancy(6-1)가 낮게 나온 뒤 추가한 것 —
`docs/EXPERIMENTS.md` "Answer Relevancy 개선" 항목 참고.
...
4. 질문에서 묻는 대상(핵심 주제·표현)을 답변 문장에 자연스럽게 되풀이하며 직접 답하십시오
   (예: "국내 출장 숙박비 한도는?" → "국내 출장 숙박비 한도는 15만 원입니다."). 질문과
   무관한 배경 설명은 덧붙이지 마십시오.
5. 답변에 사용한 내용의 출처(강의 파일명)를 자연스럽게 언급하십시오."""
