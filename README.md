...
| 지표 | 목표 | 실제 (alpha=0.4, tokens) |
|---|---|---|
| Hit Rate@5 | ≥ 0.8 | **0.923** |
| MRR | ≥ 0.5 | **0.788** |
...
전부를 새 chunk_id로 재매핑한 뒤 alpha를 0.5→0.4로 재확정했습니다. 단, 개별 항목 단위로는
트레이드오프도 있었습니다(gs-23은 새로 top-5를 놓침) — 전체 26문항 집계로는 순개선이지만,
상세 과정과 한계는 [`docs/EXPERIMENTS.md`](docs/EXPERIMENTS.md)에 정직하게 기록했습니다.
